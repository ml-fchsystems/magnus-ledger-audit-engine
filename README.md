...
- Runs paginated searches across target cities.

- Pulls up to 60 leads per city.

2. Web Latency Ingestion

- Scrapes DOM elements from lead websites.

- Benchmarks site response times in milliseconds.

3. Gemini 2.5 Flash Core

- Runs structural audits on site code.

- Calculates conversion loss scores.

- Drafts sales emails and Loom video scripts.

4. Google Workspace Matrix

- Removes duplicate records automatically.

- Logs clean lead data to Google Sheets.
